define("f68f911d-a472-401c-bbd3-54d2d7a0147f", ["@microsoft/sp-client-preview","helloWorldStrings"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_7__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* tslint:disable */
	var styles = {
	    helloWorld: 'helloWorld_7db3f1d4',
	    container: 'container_6434637c',
	    row: 'row_03ba3276',
	    listItem: 'listItem_d39e4bb3',
	    button: 'button_5e453198',
	};
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".helloWorld_7db3f1d4 .container_6434637c{max-width:700px;margin:0 auto;box-shadow:0 2px 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}.helloWorld_7db3f1d4 .row_03ba3276{padding:20px}.helloWorld_7db3f1d4 .listItem_d39e4bb3{max-width:715px;margin:5px auto 5px auto;box-shadow:0 0 4px 0 rgba(0,0,0,.2),0 25px 50px 0 rgba(0,0,0,.1)}.helloWorld_7db3f1d4 .button_5e453198{text-decoration:none}", ""]);
